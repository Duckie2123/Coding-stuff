...
Just some fun practice scripts I've made while learning Python:

- **`dog.py`** – A virtual pet dog that gets hungry in real time.
- **`game.py`** – A simple turn-based RPG battle with HP and random attack damage.
...
> [!NOTE]
> Most of these are just learning exercises, so expect messy code and random bugs :3
